...
function wildText(number) {
  ...
  if (isfound) {
    wildText(number);
      ...
      document.getElementById("disc-" + number).innerHTML = "<h4 class=\"media-heading\"><a href=\"" + text[random].http + "\">" + text[random].title + "</a></h4><p>" + text[random].Description + "</p>";
    }
}
